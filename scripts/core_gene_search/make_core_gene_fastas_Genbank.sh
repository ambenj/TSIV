...
# Inputs
PROTEINS="/labs/kingsley/ambenj/TSIV/analysis_STMY_2012_42/assembly/04_blastp_iridoviruses/core_genes_genbank.txt"
...
mkdir -p $OUT_DIR
rm ${OUT_DIR}/Genbank_core_*_proteins.fasta
...
do
    ...
    ORF_FASTA="${OUT_DIR}/Genbank_core_${order}_proteins.fasta"
