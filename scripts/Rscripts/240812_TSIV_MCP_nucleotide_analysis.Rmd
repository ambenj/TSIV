...
blastn_folder <- "/labs/kingsley/ambenj/TSIV/analysis/assembly/06_blastn_iridoviruses"

# Output files
MCP_gene_outfile <- "/labs/kingsley/ambenj/TSIV/analysis/assembly/06_blastn_iridoviruses/MCP_genes_needs_curation.txt"
```
