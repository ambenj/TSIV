...
SHORTCUT_DIR="/labs/kingsley/ambenj/TSIV/analysis/other_virus_sequences/nucleotide_DBs"
...
do
    ...
    efetch -db nucleotide -format fasta_cds_na -id $accession > ${FASTA_DIR}/${FILE_PREFIX}/${FILE_PREFIX}_orf_nucleotides.fasta

    # Make shortcut for blast search
    ln -s "../${FILE_PREFIX}/${FILE_PREFIX}_orf_nucleotides.fasta"
